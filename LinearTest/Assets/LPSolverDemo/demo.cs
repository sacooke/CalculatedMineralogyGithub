...
namespace demo
{
    public class demo : MonoBehaviour
    {
        ...
        /* go to the project property page and in ìconfiguration properties>buildÅEset Allow Unsafe Code Blocks to True. */
        ...
        private static void ThreadProc(object filename)
        {
            ...
            UnityEngine.Debug.Assert(ret == lpsolve.lpsolve_return.OPTIMAL && Math.Round(o, 13) == 1779.4810350637485);
